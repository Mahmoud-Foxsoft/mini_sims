...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $settings = [
            ...
            [
                'key' => 'privacy_content',
                'value' => '<h2>1. Information We Collect</h2>\n<p>We collect basic account information, payment confirmations, and service usage data needed to deliver phone numbers and messages.</p>\n<h2>2. SMS Handling</h2>\n<p>We store messages only as long as needed to display them in your account or API response. Messages are not sold or shared.</p>\n<h2>3. Refund Logic</h2>\n<p>If a number is unavailable or no message arrives within 15 minutes, your balance is refunded automatically.</p>\n<h2>4. API Access</h2>\n<p>API requests are logged for security and rate limiting. We do not store verification messages longer than necessary.</p>\n<h2>5. Contact</h2>\n<p>If you have privacy questions, contact us at support@quicksms.io.</p>',
                'type' => 'html',
            ...
            [
                'key' => 'terms_content',
                'value' => '<h2>1. Service Scope</h2>\n<p>QuickSMS provides temporary phone numbers for receiving SMS messages for specific services.</p>\n<h2>2. Availability</h2>\n<p>Numbers are provided based on availability. If you request five numbers and only three are available, the remaining amount is refunded automatically.</p>\n<h2>3. Message Delivery</h2>\n<p>Messages are expected within 15 minutes. If no message arrives in that time window, the order is refunded automatically.</p>\n<h2>4. API Use</h2>\n<p>You may use the API to automate number purchases and message retrieval. Abuse or excessive requests may result in limits.</p>\n<h2>5. Refunds</h2>\n<p>Refunds are credited to your balance for any unavailable numbers or expired message waits.</p>\n<h2>6. Contact</h2>\n<p>For questions about these terms, contact support@quicksms.io.</p>',
                'type' => 'html',
                'title' => 'Terms Content',
            ],
